...
include "youseeMobile/sendNotification.php";
echo "gfsdjfdsfighkjdsfhgdfjkgjhdfhgkjdfhgjhdkjfghjkdfygkldhfkgldkfgkjdfhg".$_POST['act_id'];
...
{
	?>
	<h3 align="left"> <?php echo $resultCount; ?>
	new requests!</h4>
	<hr>
	<?= $pagination; ?>
...
$oppresult=mysql_query($opp_query);
	...
	<p>
	<span style="float:left">Partner:&nbsp<b><?php echo $row['name']; ?><
	/b> </span>
	<span style="float:right;margin-right:8px;">Vertical:&nbsp<b style="color:#0C7878;"><?php echo $row['vertical']; ?><
	/b></span><br />
	<span style="float:right;margin-right:8px;">Domain:&nbsp<b style="color:#801506;"><?php echo $row['domain']; ?><
	/b></span><br /><br />
	<span style="float:right;margin-right:8px"><b><?php echo $row['onsite_offsite']; ?><
	/b></span>
	<h5 style="position:relative;top:-15px;padding:0px;margin:0px;"><?php echo $row['activity']; ?><
	/h5>
	...
	<script type="text/javascript">
		...
		<?php echo $count; ?>
			...
			for($i=0;$i<
		<?php echo $resultCount; ?>;$i++){
		$("#details"+$i).hide();
		$("#"+$i).css("background-color","#f2f2f2");
		}
		$("#details<?php echo $count; ?>
			").slideDown();
			$("#
		<?php echo $count; ?>
