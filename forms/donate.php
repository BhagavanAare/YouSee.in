...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_87639" class="appnitro"  method="post" action="processform.php">
...
<option value="Zimbabwe" >Zimbabwe</option>
		...
		<div>
			<input id="element_3" name="emailid" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_4" >
		<label class="description" for="element_4">Please confirm your email address* </label>
		<div>
			<input id="element_4" name="emailconfirm" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_6" >
		<label class="description" for="element_6">Please enter your phone number (including country code) </label>
		<span>
			<input id="element_6_1" name="phonenum" class="element text" size="13" maxlength="13" value="" type="text">
			<!-- <label for="element_6_1">(###)</label>
		</span>
		<span>
			<input id="element_6_2" name="phonenum2" class="element text" size="3" maxlength="3" value="" type="text"> -
			<label for="element_6_2">###</label>
		</span>
		<span>
	 		<input id="element_6_3" name="phonenum3" class="element text" size="4" maxlength="4" value="" type="text">
		...
		<span>
			<input id="element_5_1" name="amount_to_donate" class="element text currency" size="10" value="" type="text" />		
			<label for="element_5_1">Indian Rupees</label>
		</span>
		<!-- <span>
		...
		<div>
		<select class="element select medium" id="element_7" name="project_to_donate"> 
