<html>
  ...
  <body>
    <p align="center"><b>Location wise Volunteering Time Contributed (in Hours)</b></p>
...
$query = "SELECT SUM(hours) TOTALHOURS, LOCATION
         FROM volunteering
         GROUP BY LOCATION";

$query2 = "SELECT SUM(TOTALHOURS) ALLHOURS
          FROM(SELECT SUM(hours) TOTALHOURS, LOCATION
         FROM volunteering
         GROUP BY LOCATION)INFO";
