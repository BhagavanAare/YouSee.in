...
if(mysql_num_rows($result)!= 0) 
{
		...
		while ($record = mysql_fetch_array($result))
		{
			...
			echo "<td align=\"right\">" . number_format($total_funding) . "</td>";
			echo "</tr>";
			$i++;
			$total_total_funding = $total_total_funding + $total_funding;
			$data = $data. $total_funding. ",";
		...
		echo "</tbody>";
		echo "<tfoot><tr><td colspan='2' align=\"right\">Total</td><td align=\"right\">".number_format($total_total_funding)."</td></tr></tfoot>";
		echo "</table></br>";
}
?>
