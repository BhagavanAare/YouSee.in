...
if (isset($_POST['newDonor'])) 
{
    ...
    if (empty($_SESSION['captcha']) || trim(strtolower($_POST['captcha'])) != $_SESSION['captcha']) {	
		...
		$_SESSION['POST']=$_POST;
		header("Location: postpay_login_exec.php");
		exit();	
    }
}
?>
...
<fieldset>
<legend> Login </legend><form id="loginForm" name="loginForm" method="post" action="postpay_login_exec.php">
...
<input id="register" style="visibility: visible" name="newDonor" type="submit" value="Register" /></div>
</form>
</fieldset>
