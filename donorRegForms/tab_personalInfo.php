...
<table border="0">
	<tr>
		...
		<td><input name="fname" style="text-transform: capitalize" type="text"
			id="firstName" /></td>
		<td>
		<div class="error" id="donor_fname_errorloc"></div>
		</td>
	</tr>
	<tr>
		...
		<td><input name="lname" style="text-transform: capitalize" type="text"
			id="lastName" /></td>
		<td>
		<div class="error" id="donor_lname_errorloc"></div>
		</td>
	</tr>
	<tr>
		<td><label for="donor_type">Individual/Group*</label></td>
		<td><select name="type" id="donor_type">
			<option value="Individual">individual</option>
			<option value="Group">group</option>
		</select></td>
		<td>
		<div class="error" id="type_fname_errorloc"></div>
		</td>
	</tr>
	<tr>
		<tr>
			<td>Gender</td>
			<td>
			<p><label> <input type="radio" name="gender" value="M" id="radio_m"
				checked /> Male</label> <label> <input type="radio" name="gender"
				value="F" id="radio_f" /> Female</label> <br />
			</p>
			</td>
			<td>
			<div class="error" id="donor_fname_errorloc"></div>
		...
		<tr>
			...
			<td><input style="text-transform: capitalize" type="text"
				name="occupation" id="occupation" /></td>
			<td>&nbsp;</td>
		</tr>
	...
	<tr>
		<td><label for="pan">PAN card no.</label></td>
