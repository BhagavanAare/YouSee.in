...
$registrationIds;
function sendGCMNotification($activityID)
{
	$activityObj = array();
...
function implementGCM($registrationIdArray, $activityObj)
{
...
function writeToLog($logDataa)
{
	$fp = fopen("gcmLog.txt", "a+");
	if ($fp != null)
	{
		fwrite($fp, $logDataa . "<br />");
	}
	fclose($fp);
}
?>