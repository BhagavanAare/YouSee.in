<?
//query for selecting all Donation Camps at Hyderabad
$city = "Hyderabad";
$query = "SELECT * FROM places
          WHERE city='".$city."' AND place_type='Donation Camp'";
...
?>
    ...
    <script type="text/javascript">
      ...
      google.setOnLoadCallback(drawMap1);
      	function drawMap1() {
        var domNode = document.getElementById('cont-4-map');
    ...
    <div id="cont-4-map" style="width: 900px; height: 500px"></div>
    <br>
<?
